...
def execute(filters=None):
	...
	#Navari
	employees = get_employees(salary_slips)
	months = get_months(salary_slips)
	#End Navari
	...
	for ss in salary_slips:
		row = [ss.start_date, ss.employee_name]

		#Convert start Date to Month
		#month = [formatdate(ss.start_date, "MMM YY")
...
def get_columns(salary_slips):
	"""
	columns = [
		_("Start Date") + "::80", _("Employee Name") + "::140"
	]
	"""
	columns = [
		_("Start Date") + "::80", _("Employee Name") + "::140"
